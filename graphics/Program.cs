        ...
        static void Main(string[] args)
        {
            ...
            while (!Raylib.WindowShouldClose())
            {
                ...
                if (gameState == "level_one")
                {
                    ...
                    //RITA SPELARE
                    Raylib.DrawRectangle((int)playerX, (int)playerY, 50, 50, Color.PURPLE);
                ...
                if (gameState == "pause")
                {
                    ...
                    //TESTA OM SPELAREN VILL GÅ TILLBAKA TILL SPELET
                    if (Raylib.IsKeyPressed(KeyboardKey.KEY_TAB))
                    {
                        //LEVEL SPARAR VILKEN BANA SPELAREN ÄR PÅ SÅ MAN INTE BEHÖVER BÖRJA OM.
